...
public class MailTriggerService {
	...
	static final String FROM = "chethan99narasaiah@gmail.com";
	static final String FROMNAME = "Chethan";

	// Replace recipient@example.com with a "To" address. If your account
	// is still in the sandbox, this address must be verified.
	static final String TO = "chandancbr96@gmail.com";

	// Replace smtp_username with your Amazon SES SMTP user name.
	static final String SMTP_USERNAME = "AKIAJFGXUOERUQLI4LJQ";

	// Replace smtp_password with your Amazon SES SMTP password.
	static final String SMTP_PASSWORD = "AlYepvbjixtzaWkWM4WnmNC5iO9oeDEB5CtrGz9dtGL2";
